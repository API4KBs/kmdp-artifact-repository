...
class JcrKnowledgeArtifactRepositoryTest {
  ...
  //"List stored knowledge artifacts"
    ...
    void testListArtifactsAllAvailableDeletedFalse() {
        ...
        List<Pointer> pointers = adapter.listKnowledgeArtifacts("repository", null, null, false).getBody();
    ...
    void testListArtifactsAllReturnedDeletedTrue() {
        ...
        List<Pointer> pointers = adapter.listKnowledgeArtifacts("repository", null, null, true).getBody();
    ...
    void testInitializeNewArtifactSeries() {
        ...
        List<Pointer> artifacts = adapter.listKnowledgeArtifacts("repository", null, null, false).getBody();
        List<Pointer> versions = adapter.getKnowledgeArtifactSeries("repository", newArtifact, false, null, null, null, null, null).getBody();
    ...
    void testInitializeNewArtifactSeriesNewRepo() {
        ...
        List<Pointer> artifacts = adapter.listKnowledgeArtifacts("repository2", null, null, false).getBody();
...
//    "Check Knowledge Artifact"
    ...
    void checkSeriesAvailableWithAvailableVersions() {
      dao.saveResource("repository", artifactID, "new", "document".getBytes());
      ResponseEntity<Void> responseEntity = adapter.isKnowledgeArtifactSeries("repository", artifactID, false);
    ...
    void checkSeriesUnavailableDeletedTrue() {
        dao.saveResource("repository", artifactID);
        dao.deleteResource("repository", artifactID);
        ResponseEntity<Void> responseEntity = adapter.isKnowledgeArtifactSeries("repository", artifactID, true);
        assertEquals(HttpStatus.OK, responseEntity.getStatusCode());
    }
    ...
    void testEnableSeriesArtifactUnknown() {
        ...
        List<Pointer> artifacts = adapter.listKnowledgeArtifacts("repositoryId", null, null, false).getBody();
    ...
    void testEnableSeriesVersionsUnavailable() {
        ...
        ResponseEntity<Void> response = adapter.enableKnowledgeArtifact("repositoryId", artifactID);
        List<Pointer> versions = adapter.getKnowledgeArtifactSeries("repositoryId", artifactID, false,null, null, null, null, null).getBody();
  ...
  //"List versions of a Knowledge Artifact"
    ...
    void testListVersionsAllAvailable() {
        ...
        List<Pointer> results = adapter.getKnowledgeArtifactSeries("1", artifactID, false,0, -1, null, null, null).getBody();
    ...
    void testListVersionsSomeUnavailableDeletedTrue() {
        ...
        List<Pointer> results = adapter.getKnowledgeArtifactSeries("1", artifactID, true,0, -1, null, null, null).getBody();
    ...
    void testListVersionsEmptySeries() {
        dao.saveResource("1", artifactID);
        ResponseEntity<List<Pointer>> results = adapter.getKnowledgeArtifactSeries("1", artifactID, true,0, -1, null, null, null);
    ...
    void testGetVersionsRightPointerHref() {
        ...
        List<Pointer> result = adapter.getKnowledgeArtifactSeries("default", artifactID, false, null, null, null, null, null).getBody();
...
//        assertEquals("available", getStatus(version));
    ...
    void testGetVersionVersionAvailable()  {
        dao.saveResource("1", artifactID, "new", "hi!".getBytes());
        ResponseEntity<byte[]> response = adapter.getKnowledgeArtifactVersion("1", artifactID, "new", false);
    ...
    void testGetVersionDeletedParameterTrue()  {
        ...
        ResponseEntity<byte[]> response = adapter.getKnowledgeArtifactVersion("1", artifactID, "new", true);
        assertEquals("hi!", new String(response.getBody()));
        assertEquals(HttpStatus.OK, response.getStatusCode());
    }
    ...
    void testCheckVersionAvailable () {
        dao.saveResource("repo1", artifactID,"version","hello".getBytes());
        ResponseEntity<Void> response = adapter.isKnowledgeArtifactVersion("repo1", artifactID, "version", false);
        assertEquals(HttpStatus.OK, response.getStatusCode());
    }
    ...
    void testCheckVersionUnavailableDeletedTrue() {
        ...
        ResponseEntity<Void> response = adapter.isKnowledgeArtifactVersion("repo1", artifactID, "version", true);
        assertEquals(HttpStatus.OK, response.getStatusCode());
    }
    ...
    void testEnsureVersionUnavailable() {
        ...
        ResponseEntity<Void> response = adapter.enableKnowledgeArtifactVersion("repository", artifactID, "version", false);
       ResponseEntity<List<Pointer>> availableVersions = adapter.getKnowledgeArtifactSeries("repository", artifactID, false, null, null, null, null,null);
    ...
    void testPutOnExistingVersion()  {
        ...
        ResponseEntity<Void> response = adapter.setKnowledgeArtifactVersion("repositoryId", artifactID, "new", "replaced".getBytes());
        byte[] replacedArtifact = adapter.getKnowledgeArtifactVersion("repositoryId", artifactID, "new", false).getBody();
    ...
    void testPutOnVersionArtifactDoesNotExist()  {
        dao.saveResource("repositoryId", artifactID, "first", "hi!".getBytes());
        ResponseEntity<Void> response = adapter.setKnowledgeArtifactVersion("repositoryId", artifactID2, "new", "replaced".getBytes());
        byte[] replacedArtifact = adapter.getKnowledgeArtifactVersion("repositoryId", artifactID2, "new", false).getBody();
    ...
    void testPutOnVersionRepoDoesNotExist()  {
        dao.saveResource("repositoryId", artifactID, "first", "hi!".getBytes());
        ResponseEntity<Void> response = adapter.setKnowledgeArtifactVersion("repositoryId2", artifactID2, "new", "replaced".getBytes());
        byte[] replacedArtifact = adapter.getKnowledgeArtifactVersion("repositoryId2", artifactID2, "new", false).getBody();
    ...
    void testPutOnVersionUnavailableVersion()  {
        ...
        ResponseEntity<Void> response = adapter.setKnowledgeArtifactVersion("repositoryId", artifactID, "first", "replaced".getBytes());
        byte[] replacedArtifact = adapter.getKnowledgeArtifactVersion("repositoryId", artifactID, "first", false).getBody();
    ...
    void testPutOnVersionUnavailableArtifact()  {
        ...
        dao.deleteResource("repositoryId", artifactID);
        ResponseEntity<Void> response = adapter.setKnowledgeArtifactVersion("repositoryId", artifactID, "first", "payload".getBytes());
        byte[] replacedArtifact = adapter.getKnowledgeArtifactVersion("repositoryId", artifactID, "first", false).getBody();
    ...
    void testDeleteVersionAvailable() throws Exception {
        dao.saveResource("1", artifactID, "new", "hi!".getBytes());
        ResponseEntity<Void> response = adapter.deleteKnowledgeArtifactVersion("1", artifactID, "new", false);
    ...
    void testDeleteParameterNotImplemented() {
        ResponseEntity<Void> response = adapter.deleteKnowledgeArtifactVersion("1", artifactID, "new", true);
        assertEquals(HttpStatus.NOT_IMPLEMENTED, response.getStatusCode());
    }
